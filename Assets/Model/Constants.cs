namespace Assets.Model
{
    public static class Constants
    {
        ...
        public const string S2C_STARTED = "GAME_ALREADY_STARTED";
        public const string S2C_NOTSTARTED = "GAME_NOT_STARTED_YET";
        public const string S2C_GAMEOVER = "GAME_HAS_FINISHED";
        public const string S2C_JUSTFINISHED = "GAME_FINISHED";

        public const string S2C_PLAYERSFULL = "PLAYERS_FULL";
        ...
        public const string S2C_TOOQUICK = "TOO_QUICK";
        public const string S2C_CELLOCCUPIED = "CELL_OCCUPIED";

        // Penalty should be added for hitting obstacle or pitfall
        public const string S2C_HITOBSTACLE = "OBSTACLE";
        public const string S2C_FALLTOPIT = "PITFALL";

        public const string S2C_DEAD = "DEAD";
        ...
        public const int BULLET_MULTI = 5;
        // Update Period
